...
void main() {
  ...
  test('non-zero duration should execute target method asynchronously',
    ...
    FastDebounce.debounce(
       tag: 'test1',duration:const  Duration(microseconds: 1),onExecute:  () => onExecute());
    expect(test--, 1);
  });
  ...
  test('calling fire() should execute the callback immediately', () async {
    ...
    FastDebounce.debounce(tag: 'test1',duration: const Duration(seconds: 1),onExecute:  () => onExecute());
  ...
  test('cancelAll() cancels and removes all timers', () async {
    ...
    FastDebounce.debounce(
        tag: 'test1',duration: const Duration(milliseconds: 1000), onExecute:() => onExecute());
    FastDebounce.debounce(
        tag:  'test2',duration: const Duration(milliseconds: 1000), onExecute:() => onExecute());
    FastDebounce.debounce(
        tag:  'test3',duration: const Duration(milliseconds: 1000),onExecute:  () => onExecute());
